...
import { PartiViewComponent } from './parti-view/parti-view.component';
import { PartiUpdateComponent } from './parti-update/parti-update.component';
import { PartiCreationComponent } from './parti-creation/parti-creation.component';
...
export class PartiComponent implements OnInit {
  ...
  displayedColumns: string[] = ['position', 'code', 'nom', 'action'];
  ...
  exportToExcel() {
    this.data.exportToExcel(this.List, 'Parti');
  }
  ...
  openDialog(id: any) {
    const dialogRef = this.dialog.open(PartiViewComponent,
  ...
  openDialog2(id: any) {
    const dialogRef = this.dialog.open(PartiUpdateComponent,
      { data:{ids: id}, disableClose: true });
  ...
  openDialogCreation() {
    const dialogRef = this.dialog.open(PartiCreationComponent,
      // { data:{ids: id}, disableClose: true }
      );
