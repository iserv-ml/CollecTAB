...
@Component({
  selector: 'app-type-incident-creation',
  templateUrl: './type-incident-creation.component.html',
  styleUrls: ['./type-incident-creation.component.scss']
})
export class TypeIncidentCreationComponent implements OnInit {
  ...
  submit(values: any) {
    ...
    if(this.Form.valid)
    {
      ...
      this.typeIncidentService.add(data1).subscribe(
        (res) => {
          console.log(res);
